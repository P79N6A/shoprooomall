...
');
	...
	if (strpos($http, 'https://') === false) {
		$Loaction = 'http://www.shoprooo.com.au/cloud/platform_rec.html';
	}
	else {
		$Loaction = 'https://www.shoprooo.com.au/cloud/platform_rec.html';
	}
...
');
	...
	if (strpos($http, 'https://') === false) {
		$Loaction = 'http://www.shoprooo.com.au/cloud/best_rec.html';
	}
	else {
		$Loaction = 'https://www.shoprooo.com.au/cloud/best_rec.html';
	}
