...
function set_flash_data($tplname, &$msg)
{
	...
	if (empty($flashdata)) {
		$flashdata[] = array('src' => 'data/afficheimg/20081027angsif.jpg', 'text' => 'shoprooo', 'url' => 'http://www.shoprooo.com.au');
		$flashdata[] = array('src' => 'data/afficheimg/20081027wdwd.jpg', 'text' => 'wdwd', 'url' => 'http://www.wdwd.com');
		$flashdata[] = array('src' => 'data/afficheimg/20081027xuorxj.jpg', 'text' => 'shoprooo', 'url' => 'http://www.shoprooo.com.au/index.php?doc-view-108.htm');
	}
