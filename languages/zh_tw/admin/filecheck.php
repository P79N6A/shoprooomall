...
$_LANG['filecheck_tips_step1'] = '文件校驗是針對shoprooo官方發布的文件為基礎進行核對，點擊下面按鈕開始進行校驗。';
...
$_LANG['tips'] = '技巧提示: ';
$_LANG['filecheck_tips'] = "<li>“<em class=\"edited\">被修改</em>”、“<em class=\"del\">被删除</em>” 中的列出的文件，請即刻通過FTP或其他工具檢查其文件的正確性，以確保shoprooo網店功能的正常使用。</li>\r\n    <li>“<em class=\"unknown\">未知</em>” 中的列出的文件，請檢查網店是否被人非法放入了其他文件</li>\r\n    <li style=\"\">“<em class=\"unknown\">一周内被修改</em>” 中列出的文件，請確認最近是否修改過。</li>";
$_LANG['filename'] = '文件名';
$_LANG['filesize'] = '文件大小';
