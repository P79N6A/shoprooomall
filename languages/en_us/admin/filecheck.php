...
$_LANG['filecheck_tips_step1'] = 'shoprooo check documents for the official release of the documents as the basis for cross-checking, click the button below to start checking。';
...
$_LANG['tips'] = 'Tips: ';
$_LANG['filecheck_tips'] = "<li>“<em class=\"edited\">To be revised</em>”、“<em class=\"del\">Deleted</em>” The list of documents, instantly, through FTP or other tools to check the validity of their documents in order to ensure the normal function of shoprooo Shop use。</li>\r\n    <li>“<em class=\"unknown\">unknown</em>” The documents listed, please check whether it was illegal Shop into the other documents。</li>\r\n    <li style=\"\">“<em class=\"unknown\">The week were revised</em>” Listed in the document, make sure that the recently revised。</li>";
