...
$_LANG['filecheck_tips_step1'] = '文件校验是针对 shoprooo 官方发布的文件为基础进行核对，点击下面按钮开始进行校验。';
...
$_LANG['tips'] = '技巧提示: ';
$_LANG['filecheck_tips'] = "<li>“<em class=\"edited\">被修改</em>”、“<em class=\"del\">被删除</em>” 中的列出的文件，请即刻通过 FTP 或其他工具检查其文件的正确性，以确保shoprooo网店功能的正常使用。</li>\r\n    <li>“<em class=\"unknown\">未知</em>” 中的列出的文件，请检查网店是否被人非法放入了其他文件。</li>\r\n    <li style=\"\">“<em class=\"unknown\">一周内被修改</em>” 中列出的文件，请确认最近是否修改过。</li>";
$_LANG['filename'] = '文件名';
$_LANG['filesize'] = '文件大小';
