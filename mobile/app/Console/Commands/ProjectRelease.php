...
class ProjectRelease extends \Illuminate\Console\Command
{
	...
	public function handle()
	{
		...
		$free = array('app/Modules/Touchim/*', 'app/Plugins/connect/facebook.php', 'app/Plugins/payment/paypal.php', 'app/Plugins/payment/omipay.php', 'resources/docs/*', 'resources/client/*', 'resources/views/touchim/*', 'scripts/*', 'tests/*', '.bowerrc', '.gitattributes', '.gitignore', '.php_cs.dist', 'bower.json', 'CHANGELOG.md', 'composer.json', 'package.json', 'README.md', 'webpack.mix.js');
